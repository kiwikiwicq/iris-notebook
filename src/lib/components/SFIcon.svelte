<script lang="ts">
	...
	let { name, size = 18, color = 'currentColor', class: className = '' }: Props = $props();
</script>

<svg
	class="sf-icon {className}"
	width={size}
	height={size}
	viewBox="0 0 24 24"
	fill="none"
...
>
	...
	{:else if name === 'github'}
		...
		/>
	{:else if name === 'rss'}
		<!-- SF Symbol: antenna.radiowaves.left.and.right / rss -->
